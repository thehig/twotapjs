		...
		describe "Product [0]", ->
			...
			describe "Option 2", ->
				...
				describe "values text Color:", ->
					it "[0] 'White'", -> expect(selectOneModel.values[0]).to.have.property('text', 'Color: White')
					...
					it "[5] 'Snow'", -> expect(selectOneModel.values[5]).to.have.property('text', 'Color: Snow')
			...
			describe "Option 3", ->
				...
				describe "values text Size:", ->
					it "[0] 'Small'", -> expect(selectOneModel.values[0]).to.have.property('text', 'Size: Small')
